      ...
      <View style={ Estilo.container }> 
        ...
        <View style={Estilo.containerTitulo}>
          ...
          <View style={Estilo.containerResultado}>
            <Text style={Estilo.resultadoTexto}> Obesidade </Text>
          </View>
          ...
          <View style={Estilo.containerInfo}>            
            ...
            Diabetes, angina, infarto, aterosclerose, apneia do sono, falta de ar, refluxo, dificuldade para se mover, escaras, diabetes, infarto, AVC.
            </Text>
          </View>
